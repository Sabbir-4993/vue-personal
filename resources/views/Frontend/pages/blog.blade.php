                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="blogItem text-left">
                            ...
                            <div class="biDetails">
                                <h3><a href="single_{{route('blog')}}">A Technology Success Story You'll Never Believe</a></h3>
                                <p>
                                    Morbi ullamcorper vel nunc quis venenatis. Ut auctor dapibus dignissim. Sed tincidunt non odio id dignissim donec.
                                </p>
                                <a href="single_{{route('blog')}}" class="btt_link"><span>Read More</span></a>
                    ...
                    <div class="col-lg-6">
                        <div class="blogItem text-left">
                            ...
                            <div class="biDetails">
                                <h3><a href="single_{{route('blog')}}">The Worst Videos of All Time About Technology</a></h3>
                                <p>
                                    Morbi ullamcorper vel nunc quis venenatis. Ut auctor dapibus dignissim. Sed tincidunt non odio id dignissim donec.
                                </p>
                                <a href="single_{{route('blog')}}" class="btt_link"><span>Read More</span></a>
                    ...
                    <div class="col-lg-6">
                        <div class="blogItem text-left">
                            ...
                            <div class="biDetails">
                                <h3><a href="single_{{route('blog')}}">20 Resources That'll Make You Better at Technology</a></h3>
                                <p>
                                    Morbi ullamcorper vel nunc quis venenatis. Ut auctor dapibus dignissim. Sed tincidunt non odio id dignissim donec.
                                </p>
                                <a href="single_{{route('blog')}}" class="btt_link"><span>Read More</span></a>
